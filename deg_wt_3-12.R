...
write.table(tT, file = file.path("extdata", "wt_3m-12m.csv"), row.names = FALSE, sep = ",")
...
write.table(writable, file = file.path("extdata", "wt_3m-12m_clean.csv"), row.names = FALSE, sep = ",")
