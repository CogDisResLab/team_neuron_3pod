...
write.table(tT, file = file.path("extdata", "wt_1m-3m.csv"), row.names = FALSE, sep = ",")
...
write.table(writable, file = file.path("extdata", "wt_1m-3m_clean.csv"), row.names = FALSE, sep = ",")
