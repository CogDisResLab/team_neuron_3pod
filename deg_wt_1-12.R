...
gsms <- "XXXX0000XXXXXXXXXXX111"
sml <- strsplit(gsms, split = "")[[1L]]
...
write.table(tT, file = file.path("extdata", "wt_1m-12m.csv"), row.names = FALSE, sep = ",")
...
write.table(writable, file = file.path("extdata", "wt_1m-12m_clean.csv"), row.names = FALSE, sep = ",")
